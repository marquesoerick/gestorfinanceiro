            ...
            <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-xl">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3 mt-1">
                  {contaView.telefone && <span className="flex items-center gap-1 text-xs text-slate-500"><Phone size={11} className="flex-shrink-0" />{contaView.telefone}</span>}
                  {contaView.email && <span className="flex items-center gap-1 text-xs text-slate-500"><Mail size={11} className="flex-shrink-0" />{contaView.email}</span>}
                </div>
              </div>
